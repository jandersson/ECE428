...
xst -ifn xst.scr
move pclk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\pclk_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc pclk_exdes.ucf pclk_exdes

echo 'Running map'
map -timing -pr b pclk_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm pclk_exdes -w routed.ncd routed.v
cd ..
